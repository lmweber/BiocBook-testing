...
intro <- tryCatch(
    {
        description <- packageDescription("BiocBook-testing")
...
👉 [ghcr.io/lmweber/biocbook-testing](https://ghcr.io/lmweber/biocbook-testing) 🐳
...
#| eval: false
docker run -it ghcr.io/lmweber/biocbook-testing:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/lmweber/biocbook-testing:devel
```
...
#| eval: false
docker run -it ghcr.io/lmweber/biocbook-testing:devel bash
